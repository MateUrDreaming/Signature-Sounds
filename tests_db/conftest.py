...
TEST_DATABASE_URI_FILE = 'sqlite:///music.db'
...
def database_engine():
    ...
    database_mode = True
    repo_instance.populate(TEST_DATA_PATH_DATABASE_LIMITED, repo_instance, database_mode)
    yield engine
...
def session_factory():
    ...
    repo_instance = database_repository.SqlAlchemyRepository(session_factory)
    database_mode = True
    repo_instance.populate(TEST_DATA_PATH_DATABASE_FULL, repo_instance, database_mode)
